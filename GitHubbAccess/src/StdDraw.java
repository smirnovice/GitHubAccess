...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static final Color DEFAULT_CLEAR_COLOR = DARK_GRAY;

    // current pen color
    private static Color penColor;

    // default canvas size is DEFAULT_SIZE-by-DEFAULT_SIZE
    private static final int DEFAULT_SIZE = 520;
    private static int width  = 812;
    ...
    // default font
    private static final Font DEFAULT_FONT = new Font("Impact", Font.PLAIN, 14);
    static final Font NUMBER_FONT = new Font("Impact", Font.PLAIN, 10);
    // current font
